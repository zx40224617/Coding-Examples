...
public class LinkedList<T> {
   ...
   /**
    ...
    public void addIterator(T data) throws NullPointerException{
        if(iterator == null) {
        	throw new NullPointerException("addIterator(): iterator is "
        			+ "null. Cannot add");
    ...
    public void removeLast() throws NoSuchElementException {
        if(length == 0) {
        	throw new NoSuchElementException("removeLast(): Cannot remove"
        			+ "from an empty list");
        } else if(length == 1) {
        	first = last = iterator = null;
        } else {
   ...
   /**
     ...
     */
    public int findIndex(T data) throws NullPointerException {
